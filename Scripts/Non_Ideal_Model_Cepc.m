...
%   oscillator with inductor equivalent parallel capacitance only. In order
...
syms L C1 R C2 gm w w0 Cp positive
syms s
...
%% Derivations of w0 and cond with KCL approach
...
%% Derivations of w0 and cond with loop gain approach
...
%% Derivations of w0 and cond with determinant approach
